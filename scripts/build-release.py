...
FILES=['LICENSE','THIRD_PARTY_NOTICES.md','licenses/Microsoft.WebView2.LICENSE.txt','licenses/Microsoft.WebView2.NOTICE.txt','data/passwords/common.txt','run.py','worker.py','alembic.ini','scripts/desktop-server.py','scripts/db-upgrade.py','scripts/apply-pending-restore.py','tools/setup-runtime.ps1',
       'Microsoft.Web.WebView2.Core.dll','Microsoft.Web.WebView2.WinForms.dll','WebView2Loader.dll','SnowEdge.exe.config',
       'docs/DESKTOP.md','docs/REPORT_DELIVERY.md','docs/SCAN_CENTER.md','docs/TOOLCHAIN.md','docs/V1.7.0.md','docs/V1.7.1.md','docs/V1.7.2.md','integrations/burp-extension/dist/SnowEdge-Burp-1.0.0.jar','integrations/burp-extension/README.md']
